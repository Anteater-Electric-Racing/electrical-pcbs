...
//168097/1826940/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LT1719CS8#PBF" (originalName "LT1719CS8#PBF")
	...
	(compDef "LT1719CS8#PBF" (originalName "LT1719CS8#PBF") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "OUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "SHDN") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LT1719CS8#PBF"))
		...
		(attr "Mouser Part Number" "584-LT1719CS8#PBF")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/LT1719CS8PBF?qs=ytflclh7QUVguooTyPJ7PQ%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "LT1719CS8#PBF")
		(attr "Description" "LT1719CS8#PBF, Comparator 3 V, 5 V 8-Pin SOIC N")
		(attr "<Hyperlink>" "http://cds.linear.com/docs/en/datasheet/1719fa.pdf")
		(attr "<Component Height>" "1.752")
		(attr "<STEP Filename>" "LT1719CS8#PBF.stp")
