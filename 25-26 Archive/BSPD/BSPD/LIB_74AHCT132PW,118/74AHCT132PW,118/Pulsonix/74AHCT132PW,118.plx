...
//4691548/1826940/2.50/14/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "74AHCT132PW_118" (originalName "74AHCT132PW_118")
	...
	(compDef "74AHCT132PW,118" (originalName "74AHCT132PW,118") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "74AHCT132PW_118"))
		...
		(attr "Mouser Part Number" "771-AHCT132PW118")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Nexperia/74AHCT132PW118?qs=P62ublwmbi98EdtQFmm67Q%3D%3D")
		(attr "Manufacturer_Name" "Nexperia")
		(attr "Manufacturer_Part_Number" "74AHCT132PW,118")
		(attr "Description" "74AHC(T)132 - Quad 2-input NAND Schmitt trigger@en-us")
		(attr "<Hyperlink>" "https://assets.nexperia.com/documents/data-sheet/74AHC_AHCT132.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "74AHCT132PW,118.stp")
