...
(library Library_1
	...
	(patternDef "LEDC2012X105N" (originalName "LEDC2012X105N")
		(multiLayer
			(pad (padNum 1) (padStyleRef r140_90) (pt -1, 0) (rotation 0))
			(pad (padNum 2) (padStyleRef r140_90) (pt 1, 0) (rotation 0))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.9 1.15) (pt 1.9 1.15) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 1.9 1.15) (pt 1.9 -1.15) (width 0.05))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt 1 1.05) (pt -1.8 1.05) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.8 1.05) (pt -1.8 -1.05) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.8 -1.05) (pt 1 -1.05) (width 0.2))
		)
	)
	(symbolDef "APTD2012LSYCK" (originalName "APTD2012LSYCK")
	...
	(compDef "APTD2012LSYCK" (originalName "APTD2012LSYCK") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "APTD2012LSYCK"))
		(attachedPattern (patternNum 1) (patternName "LEDC2012X105N")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "604-APTD2012LSYCK")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Kingbright/APTD2012LSYCK?qs=AQlKX63v8Rs%252BoJzWpwxJ3A%3D%3D")
		(attr "Manufacturer_Name" "Kingbright")
		(attr "Manufacturer_Part_Number" "APTD2012LSYCK")
		(attr "Description" "Standard LEDs - SMD 0805 Dome Lens LED Yellow- 590nm")
		(attr "<Hyperlink>" "http://www.kingbrightusa.com/images/catalog/SPEC/APTD2012LSYCK.pdf")
		(attr "<Component Height>" "1.05")
		(attr "<STEP Filename>" "APTD2012LSYCK.stp")
