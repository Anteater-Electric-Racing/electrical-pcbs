...
//5908726/1826940/2.50/5/2/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SOT65P210X110-5N" (originalName "SOT65P210X110-5N")
		(multiLayer
			...
			(pad (padNum 5) (padStyleRef r100_40) (pt 1, 0.65) (rotation 90))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt -1.5 1.1) (pt -0.5 1.1) (width 0.2))
		)
	)
	(symbolDef "74LVC1G08QSE-7" (originalName "74LVC1G08QSE-7")
	...
	(compDef "74LVC1G08QSE-7" (originalName "74LVC1G08QSE-7") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "74LVC1G08QSE-7"))
		...
		(attr "Mouser Part Number" "621-74LVC1G08QSE-7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/74LVC1G08QSE-7?qs=P1JMDcb91o6ocAdFec%252BEzw%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "74LVC1G08QSE-7")
		(attr "Description" "Logic Gates Logic LVC 1 Gate SOT353 T&R 3K")
		(attr "<Hyperlink>" "https://www.mouser.in/datasheet/2/115/DIOD_S_A0010762531_1-2543394.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "74LVC1G08QSE-7.stp")
