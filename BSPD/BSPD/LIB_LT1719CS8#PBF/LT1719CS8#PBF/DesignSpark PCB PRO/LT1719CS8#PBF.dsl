...
(library Library_1
	...
	(symbolDef "LT1719CS8_PBF" (originalName "LT1719CS8_PBF")
	...
	(compDef "LT1719CS8#PBF" (originalName "LT1719CS8#PBF") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "SHDN") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LT1719CS8_PBF"))
		...
		(attr "Datasheet Link" "http://cds.linear.com/docs/en/datasheet/1719fa.pdf")
